...
public class Proyecto {
    ...
    private void configurarDesdeCero() {
        ...
        int totalBuses = in.leerEnteroRango("Cantidad total de buses (3-200) :\nExcluyendo 1 normal y 1 preferencial.",3, 200);
    ...
    private void crearTicket() {
        ...
        if (monedaOp == null) return;
        String moneda = monedaOp.equals("1") ? "COLONES" : "DOLARES";

        String servicioOp = in.leerOpcionTexto( "Crear Ticket\nServicio:\n1) VIP\n2) REGULAR\n3) CARGA\n4) EJECUTIVO\n5) NA","1","2","3","4","5");
        if (servicioOp == null) return;
        ...
        String tipoOp = in.leerOpcionTexto("Crear Ticket\nTipo de Bus (solo 1 tipo):\n1) P Preferencial\n2) D Directo\n3) N Normal","1","2","3");
        char tipo = 'N';
    ...
    private void agregarUsuario() {
        String usuario = in.leerTextoNoVacio("Agregar Usuario\nUsuario:");
        ...
        config.agregarUsuario(usuario, p);
